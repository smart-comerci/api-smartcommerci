...
async function modalAlteraLinks(elemento, idFuturo) {
  ...
  var html = `
    ...
    <div  style="padding:0 2%; margin-top: 5%" >
      <label style="font-size: 20px;" class="label">Link em uso: <br><a style="color:#f6b504" href="${getMyUrl(sessionStorage.COLUMN_ORIGIN)}" target="_blank">${getMyUrl(sessionStorage.COLUMN_ORIGIN)}</a></label>
