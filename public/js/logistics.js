...
var AFFILIATES = [],  count = 0
var mainHost = 'https://api-smartcomerci.com.br:9090'
var locais = JSON.parse(localStorage.LOJAS_CADASTRADAS)
////console.log(locais)
...
$.ajax({
    ...
    success: function (data) {
        ...
        if(data[0].delivery_methods != null ){
            DELIVERY_DETAILS =  JSON.parse(data[0].delivery_methods)
        ...
        if(data[0].lat_lon != undefined && data[0].lat_lon != null && data[0].lat_lon != ''){
        ...
        if(data[0].faixa_cep_values != null && data[0].faixa_cep_values != undefined && data[0].faixa_cep_values != ""){
            var CEPS = JSON.parse(data[0].faixa_cep_values)
            ////console.log(CEPS)
            $(".faixasCep").html(myCEPSinclude(CEPS))
            
        }
        if(data[0].exclui_faixa_cep_values != null && data[0].exclui_faixa_cep_values != undefined && data[0].exclui_faixa_cep_values != ""){
            var CEPS2 = JSON.parse(data[0].exclui_faixa_cep_values)
            ////console.log(CEPS2)
...
function start() {
    ...
    for(const k in DELIVERY_DETAILS){
        var html = '', ativado = ' ', tagPreco = DELIVERY_DETAILS[k].valor_km.toLocaleString() +" por Km"
        ...
        html ='<div onclick="abreModal(this, $(this))" style="border: 1px solid #efefef; margin-top: 5%; padding: 5%" class="row radius20 metodoEntrega">'+
                    '<div class="col-md-8">'+
                    '<div class="col-md-12"><span class="segundoTxt descricaoMetodo">'+DELIVERY_DETAILS[k].descricao+'</span></div>'+
                    '<div class="col-md-12"><span class="txtGold">R$ '+tagPreco+'</span></div>'+
                    '</div>'+
                    '<div class="col-md-4" style="padding-top: 4%;">'+
                    '<div class="switch__container"><input descricao="'+DELIVERY_DETAILS[k].descricao+'" onchange="uptadeCheckActive(\''+DELIVERY_DETAILS[k].descricao+'\')" '+ ativado+' id="switch-shadow987'+contagem+'" class="switch switch--shadow" type="checkbox"><label for="switch-shadow987'+contagem+'"></label></div>'+
                    '</div>'+
                '</div>';
...
var lojas_cadastradas = JSON.parse(localStorage.LOJAS_CADASTRADAS)
            ...
            for(const k in lojas_cadastradas ){
                var html = '<div style="background: white; margin-left: 2%; margin-top: 25px" class="col-md-3 radius20">  '+
                '<a style="max-width: 100%" affiliate_id="'+lojas_cadastradas[k].affiliate_id+'" href="/loja/'+lojas_cadastradas[k].affiliates_business_name.replace(/ /g,"_") +'"><img style="margin:auto; opacity: 0.5" src="images/default/unidade-sem-foto.jpg"></a><hr>  '+
                 '<h5 class="label" style="text-align: left; font-size: 20px; font-weight: bold">'+lojas_cadastradas[k].affiliates_business_name +'</h5>'+
...
$("#botaoEditarArea").click(function(){
    var html = '<iframe src="/map/mapas/draw.html"style="border:0; border-radius: 20px; width:100%; height: 85vh" allowfullscreen="" loading="lazy"></iframe>'
    bootbox.alert({
        message: html,
        onShow: function () {
...
$(".metodoEntregaRetirada").click(function(event){
    if(event.target.className.indexOf("switch") > -1 || event.target.className == ""){
    ...
    var html =
        '<div style="max-width:100% " class="container">' +
            '<div class="row" style="    box-shadow: 0px 3px 5px #edf2f6; max-width: 90%;    margin: -0.8% auto;  ">' +
                ...
                "</div>" +
                '<div class="col-md ">' +
                    '<div onclick="salvaModal(\''+nome_metodo+'\')" style="cursor:pointer;border-radius: 20px; font: normal normal bold 1rem Roboto; background-color: #f6b504; max-width: 200px; height: 40px; border: 2px solid #f6b504; float: left; margin:5% auto" class="input-group">' +
                    ...
                    '<div style="padding: 5%; margin-top: 3%;" class="col-md-12 subGrupo2">' +
                        ...
                        '<div  class="corridaHorarios horizontalScroll">'+
                            '<div dia="segunda" class="cardHorarios card horarioEntrega">'+
                                '<div class="card-header">'+
                                    '<div style="justify-content: center;padding: 10px;" class="row">'+                            
                                                    '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow975414'+contagem+'" class="switch switch--shadow ativadoS" type="checkbox" /><label for="switch-shadow975414'+contagem+'"></label></div>' +
                            ...
                            '<div dia="terca" class="cardHorarios card">'+
                                '<div class="card-header">'+
                                    '<div style="justify-content: center;padding: 10px;" class="row">'+                            
                                                    '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow975424'+contagem+'" class="switch switch--shadow ativadoS" type="checkbox" /><label for="switch-shadow975424'+contagem+'"></label></div>' +
                            ...
                            '<div  dia="quarta" class="cardHorarios card">'+
                                '<div class="card-header">'+
                                    '<div style="justify-content: center;padding: 10px;" class="row">'+                            
                                                    '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow975434'+contagem+'" class="switch switch--shadow ativadoS" type="checkbox" /><label for="switch-shadow975434'+contagem+'"></label></div>' +
                            ...
                            '<div  dia="quinta" class="cardHorarios card">'+
                                '<div class="card-header">'+
                                    '<div style="justify-content: center;padding: 10px;" class="row">'+                            
                                                    '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow975444'+contagem+'" class="switch switch--shadow ativadoS" type="checkbox" /><label for="switch-shadow975444'+contagem+'"></label></div>' +
                            ...
                            '<div dia="sexta" class="cardHorarios card">'+
                                '<div class="card-header">'+
                                    '<div style="justify-content: center;padding: 10px;" class="row">'+                            
                                                    '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow975454'+contagem+'" class="switch switch--shadow ativadoS" type="checkbox" /><label for="switch-shadow975454'+contagem+'"></label></div>' +
                            ...
                            '<div  dia="sabado" class="cardHorarios card">'+
                                '<div class="card-header">'+
                                    '<div style="justify-content: center;padding: 10px;" class="row">'+                            
                                                    '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow975464'+contagem+'" class="switch switch--shadow ativadoS" type="checkbox" /><label for="switch-shadow975464'+contagem+'"></label></div>' +
                            ...
                            '<div dia="domingo" class="cardHorarios card">'+
                                '<div class="card-header">'+
                                    '<div style="justify-content: center;padding: 10px;" class="row">'+                            
                                                    '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow975474'+contagem+'" class="switch switch--shadow ativadoS" type="checkbox" /><label for="switch-shadow975474'+contagem+'"></label></div>' +
                ...
                '<div class="container" style="max-width: 70%;">' +
                    '<div style="padding: 5%;" class="col-md-12 ">' +
                        ...
                        '<div class="areaEsconde">' +
                            ...
                            '<div class="group-input2"><input fieldName="descricao" class="form-control inputProduct detalheEntrega"   onchange="alteraField($(this))" value="'+nome_metodo+'" placeholder="Nome do método" /></div>' +
                            ...
                            '<div style="padding: 5%; margin-top: 3%;" class="col-md-12 subGrupo2">' +
                                ...
                                '<div style="margin-left: 0px;" class="row">' +
                                    ...
                                    '<div   style="display: inline-flex; max-width: 35%; background: #EFEFEF;"><input fieldName="valor_km_texto" class="form-control inputProduct detalheEntrega"  onchange="alteraField($(this))" placeholder="0 km"   list="forDelivery" id="valorProduto">'+/*arrowDown+*/'</div>' +
        ...
        "</div>";
            ...
            bootbox.alert({
                ...
                onShow: function () {
                    ...
                    ////console.log(dadosMetodo)
                    if(dadosMetodo.entrega_agendada_horarios != null && dadosMetodo.entrega_agendada_horarios != undefined && dadosMetodo.entrega_agendada_horarios != ""){
                            ...
                            for(const k in lista){
                                if(dia == lista[k].dia){
                                    ...
                                    if(lista[k].horarios.length > 0){
                                        ...
                                        for(const e in essa){
                                           elemento.append(cardHorarioJSON((e+1), essa[e].limiteAtivo, essa[e].limiteValor, essa[e].inicio, essa[e].fim))
                                        }
                                    }
                                }
                            }
...
function modalEntregaRetirada(descricaoMetodo) {
    var dadosDefault = []
    if(localStorage.FULL_DELIVERY_DEFAULT != undefined && localStorage.FULL_DELIVERY_DEFAULT != null && localStorage.FULL_DELIVERY_DEFAULT != ""){
        dadosDefault = JSON.parse(localStorage.FULL_DELIVERY_DEFAULT)
    }
    ...
    var html =
        '<div style="max-width:100% " class="container">' +
            '<div class="row" style="    box-shadow: 0px 3px 5px #edf2f6; max-width: 90%;    margin: -0.8% auto;  ">' +
                ...
                "</div>" +
                '<div class="col-md ">' +
                    '<div fieldName="retirada_agendada_horarios" onclick="salvaModal2(\''+nome_metodo+'\', $(this))" style="cursor:pointer;border-radius: 20px; font: normal normal bold 1rem Roboto; background-color: #f6b504; max-width: 200px; height: 40px; border: 2px solid #f6b504; float: left; margin:5% auto" class="input-group">' +
                    '<label  style="cursor:pointer;margin: -7% auto;text-align: center;    min-width: 60%; color: white !important; font-size: 1.2rem" class="label">Salvar</label>' +
                    "</div>" +
                "</div>" +
            "</div>" +
                ...
                '<div class="container" style="max-width: 70%;">' +
                    '<div style="padding: 5%;" class="col-md-12 ">' +
                        ...
                        '<div class="areaEsconde">' +
                            ...
                            '<div class="group-input2"><input fieldName="retirada_descricao" onchange="updateDefaultParameters($(this))" class="form-control inputProduct " value="'+nome_metodo+'" placeholder="Nome do método"  /></div>' +
        ...
        "</div>";
            ...
            bootbox.alert({
                ...
                onShow: function () {
                    ...
                    ////console.log(dadosDefault)
                    if(dadosDefault[0].retirada_agendada_horarios != null && dadosDefault[0].retirada_agendada_horarios != undefined && dadosDefault[0].retirada_agendada_horarios != ""){
                        var lista =  JSON.parse(dadosDefault[0].retirada_agendada_horarios )
                        ////console.log("lista")
                        ////console.log(lista)
                        $(".listaHorariosCadastrados").each(function() {
                            var dia = $(this).attr("dia")
...
function addCard(lastID, elemento){
    ...
    var html = '<br><div class="umHorario card">'+  
                    '<div style="    padding-left: 25px;" class="row">'+
                        '<span class="segundoTxt modalTitulo2 lastIdCard">'+lastID+'</span><br>'+
                    '</div>'+
                    '<div style="justify-content: center;padding: 10px;" class="row">'+
                        '<div class="col-md-6">'+
                    ...
                    '<div style="padding-left: 25px;" class="row">'+
                        '<div class="col-md-6">'+
                            '<div class="row">'+
                                '<div style="margin-top: -1%;" class="switch__container ajuste2"><input id="switch-shadow18555'+lastID+''+count+'" class="switch switch--shadow limiteS" type="checkbox" /><label for="switch-shadow18555'+lastID+''+count+'"></label></div>' +
...
function cardHorarioJSON(lastID, limite, limiteValor, inicio, fim){
    ...
    var html = '<br><div class="umHorario card">'+  
                    ...
                    '<div style="justify-content: center;padding: 10px;" class="row">'+
                        '<div class="col-md-6">'+
                            '<label class="txtLabel" style="margin-left: 3%;font: normal normal bold 14px/21px Roboto;"> Início</label>' +  
                            '<div class="group-input2" ><input  value="'+inicio+'"  style="font-size: 16px !important;" class="form-control inputProduct inicioS " placeholder="10:00"  ></div><br>'+
                        '</div>'+
                        '<div class="col-md-6">'+
                            '<label class="txtLabel" style="margin-left: 3%;font: normal normal bold 14px/21px Roboto;"> Fim</label>' +  
                            '<div class="group-input2" ><input value="'+fim+'"  style="font-size: 16px !important;" class="form-control inputProduct fimS " placeholder="10:00"  ></div><br>'+
                        '</div>'+                                    
                    '</div>'+
                    '<div style="padding-left: 25px;" class="row">'+
                        '<div class="col-md-6">'+
                            '<div class="row">'+
                                '<div style="margin-top: -1%;" class="switch__container ajuste2"><input '+limiteTag+'  id="switch-shadow18555'+lastID+''+count+'" class="switch switch--shadow limiteS" type="checkbox" /><label for="switch-shadow18555'+lastID+''+count+'"></label></div>' +
                                '<label class="txtLabel" style="margin-left: 3%;"> Limite</label>' +                                    
                            '</div>'+                                   
                        '</div>'+
                        '<div class="col-md-6">'+
                            '<div class="meuComboInner">'+
                                '<select value="'+limiteValor+'" class="valorLimeteS">'+ 
                                        
                                    '<option>'+limiteValor+'</option>'+
                                    '<option>01</option>'+
                                    '<option>02</option>'+
                                    '<option>03</option>'+
                                    '<option>04</option>'+
...
function alteraField(elemento) {
    ...
    if(nome_metodo == ""){
        ...
        if(elemento.attr("fieldName") == "localidade_exclui_ceps"){
            ...
            var myExcludeCEPS = []
            pai.each(function () {
                myExcludeCEPS.push({"posicao":$(this).attr("posicao"), "valor":$(this).val()})
            })
...
function salvaModal(nome_metodo) {
    ...
    $(".cardHorarios").each(function() {
        ...
        dadosEntregaHorario.push({"dia":dia, "status":status, "horarios":horariosDia})
        
    })
    ////console.log(dadosEntregaHorario)

    updateDetailsDelivery(nome_metodo, 'entrega_agendada_horarios',  dadosEntregaHorario)
...
function faixaCepSettings(elemento) {
            ...
            var myCEPS = []
            pai.each(function () {
                var parCEPS1 = $(this).find(".CEP_INICIAL"),parCEPS2 = $(this).find(".CEP_FINAL")
...
$(".insereFaixaCep").click(function() {
    ...
    var html = '<div tipo="include" class="row  parCEPS">'+
                    '<div style="padding-left: none;" class="col-md-4">'+
                    '<label class="txtLabel">Inicial</label><br>'+
...
$(".insereFaixaCepExcluir").click(function() {
    ...
    ////console.log("clicsicsi")
    var html = '<div tipo="exclude" class="row  parCEPS2">'+
                    '<div style="padding-left: none;" class="col-md-4">'+
                    '<label class="txtLabel">Inicial</label><br>'+
...
function myCEPSinclude(dados){
    ...
    for(const k in dados){
        html += '<div tipo="include" class="row  parCEPS">'+
                    '<div style="padding-left: none;" class="col-md-4">'+
                    '<label class="txtLabel">Inicial</label><br>'+
                    '<div class="group-input2"><input  onchange="faixaCepSettings($(this))" class="form-control inputProduct cep CEP_INICIAL" value="'+dados[k].valor1+'" placeholder="132001-001" posicao="'+dados[k].posicao1+'"></div><br>'+

                    '</div>'+
                    '<div  style="padding-left: none;" class="col-md-4">'+
                    '<label class="txtLabel">Final</label><br>'+
                    '<div class="group-input2"><input  onchange="faixaCepSettings($(this))" class="form-control inputProduct  cep CEP_FINAL"  value="'+dados[k].valor2+'" placeholder="132001-001" posicao="'+dados[k].posicao2+'"></div><br>'+
...
function myCepsExclude(dados){
    ...
    for(const k in dados){
        ...
        html += '<div tipo="exclude" class="row  parCEPS">'+
                    '<div style="padding-left: none;" class="col-md-4">'+
                    '<label class="txtLabel">Inicial</label><br>'+
                    '<div class="group-input2"><input  onchange="faixaCepSettingsExcluir($(this))" class="form-control inputProduct cep CEP_INICIAL" value="'+valor1+'" placeholder="132001-001" posicao="'+dados[k].posicao1+'"></div><br>'+

                    '</div>'+
                    '<div  style="padding-left: none;" class="col-md-4">'+
                    '<label class="txtLabel">Final</label><br>'+
                    '<div class="group-input2"><input  onchange="faixaCepSettingsExcluir($(this))" class="form-control inputProduct  cep CEP_FINAL"  value="'+valor2+'" placeholder="132001-001" posicao="'+dados[k].posicao2+'"></div><br>'+
