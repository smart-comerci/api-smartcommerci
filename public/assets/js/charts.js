...
$.ajax({
  type: 'POST',
  url: 'https://api-smartcomerci.com.br:9090/getAllOrdersMaster',
  ...
  success: function (data) {
      ...
      //console.log(data) 
      var pedidosRecebidos = [], separacao = [], rotaEntrega = [], entregues = [], valorTotal = 0
      for(const k in data){
      ...
      var dias =  []
      var ordenes = OrdenaJson(data,'createdAt', 'ASC'), currDay = ''
