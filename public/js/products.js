    ...
    success: function (products) {
      ...
      for (const k in products) {
        ...
        var html =
          ...
          pictureToShow +
          '), url(https://cms.api-smartcomerci.com.br/images/default/produto-sem-imagem.jpg)" class="image img">' +
...
function modalProduct(PRODUCTS, product_code, affiliate_id, URLS) {
  ...
  var htmlModal =
    ...
    `<li class="thumbProduct thumbProductUpload"><input id="pegaFoto" style="display:none" type="file"><a data-target="#pic-2" data-toggle="tab"><img class="imageThumb "  src="images/products/upload.svg"   onError="this.onerror=null;this.src='https://cms.api-smartcomerci.com.br/images/default/produto-sem-imagem.jpg';"></a></li>` +
    "</ul>" +
    "</div>" +
    "</div>" +
    ...
    bootbox.alert({
      ...
      onShow: function () {
        ...
        function uploadPicture(elemento, product_code, affiliate_id) {
          ...
          var urlNew =
            "https://cms.api-smartcomerci.com.br/images/" +
            affiliate_id +
            "/" +
            product_code +
            "/" +
...
async function getProductData(EAN, elementParent, pai) {
  ...
  if (EAN != 0 && EAN != undefined && EAN != "" && EAN != null) {
    try {
      let picture = {
        thumbnail:
          "https://cms.api-smartcomerci.com.br/pictures_ean/" + EAN + ".png",
      };
...
function imageShows(affiliate_id, product_code, URLS) {
  ...
  html += `<div draggable="true" class="  thumbProduct mainImageThumb" ><figure class="figurefx pushup"><img   id="${affiliate_id}_${product_code}" class="firstImageShow mainImageShow notCrash droptarget" src="${urlCurrent}"  onError="this.onerror=null;this.src='https://cms.api-smartcomerci.com.br/images/default/produto-sem-imagem.jpg';" ><figcaption  onmouseleave="mLeave($(this))"  onmouseover="mOver($(this))" class="droptarget">${del} <br>${moveButton}<span class="textFig">Imagem Principal</span></figcaption></figure></div>`;
      ...
      if (contador <= limite) {
        ...
        html +=
          ...
          produtoURL(product_data[k].product_ean, PRODUCTS_IMAGES).DATA
            .thumbnail +
          '), url(https://cms.api-smartcomerci.com.br/images/default/produto-sem-imagem.jpg);">' +
...
function cardSelecionadoPromo(product_data, onde) {
  var html =
    ...
    produtoURL(product_data.product_ean, PRODUCTS_IMAGES).DATA.thumbnail +
    '), url(https://cms.api-smartcomerci.com.br/images/default/produto-sem-imagem.jpg)"></div>' +
    "</div>" +
  ...
  if (dados != undefined) {
    ...
    for (const k in data) {
      var html =
        ...
        '<div style="background: url(' +
        produtoURL(data[k].product_ean, PRODUCTS_IMAGES).DATA.thumbnail +
        '), url(https://cms.api-smartcomerci.com.br/images/default/produto-sem-imagem.jpg)" class="bkgImagem"></div>' +
        "</div>" +
